...
export default function MatrixGrid({
  ...
  return (
    <div className="rounded-lg border border-[color:var(--text-secondary)]/25 bg-[var(--bg-secondary)]/50">
      <div className="overflow-auto">
        <table className="w-full min-w-[640px] border-collapse text-sm">
          <thead>
            <tr className="border-b border-[color:var(--text-secondary)]/25 bg-[var(--bg-secondary)]/80">
      ...
      <div className="flex items-center justify-between gap-3 border-t border-[color:var(--text-secondary)]/25 px-4 py-3">
